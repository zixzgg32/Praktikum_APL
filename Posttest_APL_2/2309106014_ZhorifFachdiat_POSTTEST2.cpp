...
int menu2(int jumlah,string items[],string jenis){
...
int main(){
	...
	if(login==true){
		while(ulang==true){
			...
			cin>>pilihan;  
			if(pilihan=="1"){
				jmlCommon=menu2(jmlCommon,commonItems,"Common Items");
			}else if(pilihan=="2"){
				jmlUncommon=menu2(jmlUncommon,uncommonItems,"Uncommon Items");
			}else if(pilihan=="3"){
				jmlLegendary=menu2(jmlLegendary,legendaryItems,"Legendary Items");
			}else if(pilihan=="4"){
				jmlBoss=menu2(jmlBoss,bossItems,"Boss Items");
			}else if(pilihan=="5"){
				jmlLunar=menu2(jmlLunar,lunarItems,"Lunar Items");
			}else if(pilihan=="6"){
				jmlVoid=menu2(jmlVoid,voidItems,"Void Items");
			}else if(pilihan=="7"){
				jmlActive=menu2(jmlActive,activeItems,"Active Items");
			}else if(pilihan=="8"){
				cout<<"\nKeluar Program";
				ulang=false;
			}else {
